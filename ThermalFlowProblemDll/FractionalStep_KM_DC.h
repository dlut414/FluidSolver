...
*/
//FractionalStep_KM_DC.h
///defination of class FractionalStep_KM_DC (Kim & Moin - using deferred correction)
...
namespace SIM {
	...
	class FractionalStep_KM_DC : public Simulator<R,D,FractionalStep_KM_DC<R,D,P>> {};

	template <typename R, int P>
	class FractionalStep_KM_DC<R,1,P> : public Simulator<R,1,FractionalStep_KM_DC<R,1,P>> {};

	template <typename R, int P>
	class FractionalStep_KM_DC<R,2,P> : public Simulator<R,2,FractionalStep_KM_DC<R,2,P>> {
...
#pragma omp parallel for
	...
	template <typename R, int P>
	class FractionalStep_KM_DC<R,3,P> : public Simulator<R,3,FractionalStep_KM_DC<R,3,P>>  {};
}